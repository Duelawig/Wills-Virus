...
del %temp%\thanks.wav
del %temp%\creepy.mp3
del %temp%\wouldyousay.wav
del %temp%\creepy2.mp3
del %temp%\again.wav
del %temp%\goodjob.wav
del %temp%\tryagain.wav
del %temp%\areyousure.mp3
del %temp%\bruh.vbs
del %temp%\fnaf.vbs
del %temp%\vine.vbs
del %temp%\thanks.vbs
del %temp%\creepy.vbs
del %temp%\wouldyousay.vbs
del %temp%\creepy2.vbs
del %temp%\again.vbs
del %temp%\goodjob.vbs
